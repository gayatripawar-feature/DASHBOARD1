...
//         {/* Out Share Button */}
//         <button className="btn btn-primary" onClick={handleOutShare}>
//           Out Share
//         </button>
//       </div>
...
//                     <td>
//                       {/* Type of Document Column with Dropdown */}
//                       <select className="form-control" value={row.documentType || ''}>
//                         <option value="">Select Type</option>
...
//           {/* Add Row Button */}
//           <button className="btn btn-secondary me-2">Add Row</button>
//           {/* Submit and Cancel Buttons */}
...
//       {/* Project Display Table (Visible by default) */}
//       {showProjectTable && (
//         <div className="mt-4">
//           <div className="table-responsive">
//             <table className="table table-striped table-bordered mt-3">
...
//       {/* Shared With Me Table (Visible when selected) */}
//       {activeIcon === 'shared' && (
//         <div className="mt-4">
...
//               <thead>
//                 <tr>
//                   <th className="fw-bold bg-primary text-center">Shared From</th>
//                   <th className="fw-bold bg-primary text-center">Timestamp</th>
//                   <th className="fw-bold bg-primary text-center">Share To</th>
//                   <th className="fw-bold bg-primary text-center">Type of Document</th>
//                   <th className="fw-bold bg-primary text-center">Document</th>
...
//               </thead>
//               <tbody>
//                 {sharedWithMeRows.map((row, index) => (
//                   <tr key={index}>
...
//         </div>
//       )} */}
// {/* // Project Display Table (Visible by default, hidden when 'Shared With Me' is selected) */}
// {showProjectTable && activeIcon !== 'shared' && (
//   <div className="mt-4">
//     <div className="table-responsive">
//       <table className="table table-striped table-bordered mt-3">
//         <thead>
...
//       {/* Shared With Me Table (Only show when 'Shared With Me' tab is clicked) */}
// {activeIcon === 'shared' && (
//   <div className="mt-4">
//     {/* <h4>Documents Shared With Me</h4> */}
//     <div className="table-responsive">
//       <table className="table table-striped table-bordered mt-3">
//         {/* Show headers only when the Shared With Me section is active */}
//         <thead>
//           <tr>
//             <th className="fw-bold bg-primary text-center fs-5">Shared From</th>
//             <th className="fw-bold bg-primary text-center fs-5">Timestamp</th>
...
//           {/* Pagination Controls (Positioned like Out Share Button) */}
      ...
      <div className="d-flex justify-content-between align-items-center mt-4">
        ...
        <div className="d-flex align-items-center">
          ...
          {pageNumbers.map((number) => (
            <button
              key={number}
              className={`btn btn-secondary ms-2 ${currentPage === number ? 'active' : ''}`}
              onClick={() => handlePageChange(number)}
            >
              {number}
            </button>
